...
describe('CalculationsService', () => {
  ...
  describe('calculateGainLoss', () => {
    ...
    it('should maintain precision with decimal values', () => {
      ...
      // Current value: 1.23456789 * 2000.12345678 = 2469.3076...
      // Cost basis: 1.23456789 * 1234.56789012 = 1524.1111...
      // Gain/loss: 2469.3076... - 1524.1111... = 945.1965...
      expect(result.amount.toFixed(4)).toBe('945.1965');
      expect(result.isProfit).toBe(true);
    });
  });
