 ...
 */
export const syncEarnPositions = (earningsService: EarningsService) =>
 ...
 */
export const syncRewardsHistory = (earningsService: EarningsService) =>
  async (req: Request, res: Response): Promise<Response> => {
    // TODO: Get userId from auth middleware
    const userId = (req.headers['x-user-id'] as string) || 'mock-user-id';
 ...
 */
export const getEarningsSummary = (earningsService: EarningsService) =>
  async (req: Request, res: Response): Promise<Response> => {
    // TODO: Get userId from auth middleware
    const userId = (req.headers['x-user-id'] as string) || 'mock-user-id';
 ...
 */
export const getEarnPositions = (earningsService: EarningsService) =>
  async (req: Request, res: Response): Promise<Response> => {
    // TODO: Get userId from auth middleware
    const userId = (req.headers['x-user-id'] as string) || 'mock-user-id';
 ...
 */
export const getRewardsHistory = (earningsService: EarningsService) =>
  async (req: Request, res: Response): Promise<Response> => {
    // TODO: Get userId from auth middleware
    const userId = (req.headers['x-user-id'] as string) || 'mock-user-id';
